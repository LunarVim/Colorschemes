local LSP = {
		...
		DiagnosticsSignError = {fg = C.error_red, },
		DiagnosticsSignWarning = {fg = C.warning_orange, },
		DiagnosticsSignInformation = {fg = C.info_yellow, },
		DiagnosticsSignHint = {fg = C.hint_blue, },
