local LSP = {
		...
		LspReferenceRead = {fg = C.violet, bg = C.base2, style = "bold", },
		LspReferenceText = {fg = C.violet, bg = C.base2, style = "bold", },
		LspReferenceWrite = {fg = C.magenta, bg = C.base2, style = "bold", },
