local highlights = {
		...
		PmenuSel = {fg = C.bg, bg = C.ui3_blue, },
		...
		DiffText = {bg = C.diff_green_bg_dark, },
		DiffAdd = {bg = C.diff_green_bg, },
		DiffChange = {bg = C.diff_green_bg, },
		DiffDelete = {fg = C.diff_red_fg, bg = C.diff_red_bg, },
		...
		Search = {fg = C.base3, bg = C.search_blue, },
		IncSearch = {fg = C.base3, bg = C.light_gray, },
